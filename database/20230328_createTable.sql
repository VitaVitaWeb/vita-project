...
create or replace table vita_member
(
...
create or replace index IX_vita_member
    on vita_member (name);

create or replace table vita_naver_result
(
...
create or replace table vita_search
(
...
create or replace table vita_sur_formulation
(
...
create or replace table vita_sur_function
(
...
create or replace table vita_sur_prefer
(
...
create or replace table vita_sur_vitamin
(
...
create or replace table vita_survey
(
...
create or replace table vita_vita
(
...
create or replace table vita_formulation
(
    vno  int auto_increment
        primary key,
    cap  tinyint(1) default 0 null,
...
create or replace table vita_function
(
    vno    int auto_increment
        primary key,
    sc     tinyint(1) default 0 null,
...
create or replace table vita_prefer
(
    vno  int auto_increment
        primary key,
    mny  tinyint(1) default 0 null,
...
create or replace table vita_vitamin
(
